...
| ipmitool sdr                                | V   | 4-5-webui\_part1          |
| all sensor display normal                   | V   | 6-sensor                  |
| ipmitool sensor                             | V   | 6-sensor                  |
| ipmitool sdr list                           | V   | 6-sensor                  |
| ipmitool sdr type fan                       | V   | 6-sensor                  |
| ipmitool sdr type temp                      | V   | 6-sensor                  |
| ipmitool sdr type voltage                   | V   | 6-sensor                  |
| ipmitool sdr \| g PSU                       | V   | 6-sensor                  |
...
| ipmitool sel elist                          | V   | 7-SEL                     |
| ipmitool sel save (file name)               | V   | 7-SEL                     |
| ipmitool sel clear                          | V   | 7-SEL                     |
| ipmitool sel clear && sel elist             | V   | 7-SEL                     |
