...
|page			|group					|todo												|status	|
|:--:			|:--:					|:--:												|:--:	|
|1-flashimage	|						|ipmitool lan print 1									|<->	|
|3-os			|						|ipmitool mcinfo										|<->	|
|				|						|ipmitool userlist1									|<->|
|				|staticip				|sudo ipmitool lan set 1 isprcstatic						|pass|
|				|staticip				|sudo ipmitool lan set 1 ipaddr192.168.199.11			|pass|
|				|staticip				|sudo ipmitool lan set 1 netmask255.255.255.0			|pass|
|				|staticip				|sudo ipmitool lan set 1 defgw192.168.199.1				|pass|
|				|staticip				|sudo ipmitool lan set 1 arprespondon					|pass|
|				|setusername&pswd		|sudo ipmitool userset1								|<->|
|				|setusername&pswd		|sudo ipmitool usersetname2admin						|<->|
|				|setusername&pswd		|sudo ipmitool usersetpassword2admin					|<->|
|				|setusername&pswd		|sudo ipmitool usersetenable2							|<->|
|				|setusername&pswd		|sudo ipmitool userpriv241							|<->|
|				|setusername&pswd		|sudo ipmitool channelsetaccess12						|<->|
